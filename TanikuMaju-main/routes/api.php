...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Route::get('/user/name', [UserController::class, 'getNameById']);
    // Route::get('/user', [UserController::class, 'getAllNames']);

    // Route::get('/total/data', [DataCountController::class, 'countData']);
    ...
    // Route::get('/satuan/{id}', [SatuanController::class, 'getById'])->name('satuan.getById');
    ...
    // Route::patch('/paket/{paket}', [PaketController::class, 'update'])->name('paket.update');
...
Route::middleware('web')->group(function () {
    ...
    // Route::get('/paket/naskot/limited', [PaketController::class, 'getNasiKotakLimited']);
    ...
    // Route::get('/pakets/{paket}', [PaketController::class, 'getById'])->name('getById');

    // Route::get('/paket/{paket}/items', [PaketController::class, 'items'])->name('paket.items');
    // Route::get('/paket/kategori/{kategori}', [PaketController::class, 'getByCategory']);
